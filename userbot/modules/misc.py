...
async def killdabot(event):
    ...
    await event.edit("`Mematikan TG-UserBot....`")
    await asyncio.sleep(7)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#SHUTDOWN \n"
                                        "`TG-UserBot Telah Dimatikan`")
    await bot.disconnect()


@register(outgoing=True, pattern="^.restart$")
async def killdabot(event):
    await event.edit("`Restarting TG-UserBot...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#RESTARTBOT \n"
                                        "`TG-UserBot Telah Di Restart`")
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[Lord-Userbot Repo](https://github.com/W29F/TG-UserBot/blob/TG-UserBot/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "❃ **Repo Userbot:** [TG-UserBot](https://github.com/W29F/TG-UserBot)\n❃ **Pemilik:** "
    )
