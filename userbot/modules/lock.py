...
async def locks(event):
    ...
    if input_str == "msg":
        ...
        if not input_str:
            await event.edit("`Mohon Maaf {ALIVE_NAME}, Apa Yang Harus Saya Kunci? ヅ`")
            return
        else:
            await event.edit(f"`{ALIVE_NAME} Jenis Yang Mau Anda Kunci Tidak Valid` `{input_str}`")
            return
    ...
    try:
        ...
        await event.edit(f"`{ALIVE_NAME}Telah Mengunci {what} Untuk Obrolan Ini ヅ`")
...
async def rem_locks(event):
    ...
    if input_str == "msg":
        ...
        if not input_str:
            ...
            await event.edit(f"`{ALIVE_NAME} Jenis Kunci Yang Mau Anda Buka Tidak Valid` `{input_str}`")
            return
    ...
    try:
        ...
        await event.edit(f"`{ALIVE_NAME} Telah Membuka Kunci {what} Untuk Obrolan Ini ヅ`")
    except BaseException as e:
        await event.edit(
            f"`Apakah {ALIVE_NAME} Mempunyai Izin Melakukan Itu Disini?`\n**Kesalahan:** {str(e)}")
        return
